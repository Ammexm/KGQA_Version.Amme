...
# For example:	 //title[@lang="eng"]
# 它代表选择所有名称为title，同时属性ang的值为eng的节点。
# XPath语法链接：https://blog.csdn.net/weixin_43854358/article/details/96428401
...
class CrimeSpider:
    ...
    def url_parser(self, content):
        # 创建一个XPath解析对象：调用HTML类进行初始化HTML文本
        selector = etree.HTML(content)
        # 选择所有名称为h2，同时class="item-title"的节点的子节点的href属性值
